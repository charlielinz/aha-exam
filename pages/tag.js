    ...
    <>
      <div className="flex h-screen">
        ...
        <div className="mx-auto mt-20 overflow-auto">
          <p className="sticky top-0 bg-home text-3xl leading-[45px] tracking-[0.25px] pb-3 mb-3">
            Tags
          </p>
            ...
            {tags.map((tag, index) => (
              <div className="flex flex-col" key={index}>
                <div className="flex w-[150px] h-[150px] bg-white bg-opacity-5 rounded-[10px] mb-2.5">
                  <div className="self-end truncate text-2xl leading-9 font-bold mx-2.5 mb-3.5 py-[7px] px-[14px] border-4 border-white rounded-lg">
                    {tag.name}
                  </div>
                </div>
